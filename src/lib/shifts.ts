 ...
 * @param props.isEditable Whether the event is currently editable.
 * @param props.event The event the shift belongs to.
 * @param props.redirectUri The URI to redirect to after the action is complete. Can be a string or a function that takes the deleted shift and returns a string.
